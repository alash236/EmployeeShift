...
import { UpdateClock } from '../../@Dialog/update-clock/update-clock';


@Component({
  selector: 'app-back-clock',
  imports: [MatTableModule, MatPaginatorModule, MatInputModule, MatOption, MatSelectModule,FormsModule],
